...
public class Story extends Hero {
	...
	private String userClassSelection = c.classBuilder(c.getUserInput());

	public Story(String name, String backStory, String[] pronouns) {
		super(name, backStory, pronouns);
	}
	...
	public String backStory(String input) {
